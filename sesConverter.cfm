...
<fusedoc language="ColdFusion 4.5.2" specification="2.0">
	...
	<properties>
		...
		<property name="lastUpdated" value="19-Dec-2001" />
		<history author="Bert Dawson" email="bert@redbanner.com" role="Architect" type="Create"/>
		<history author="Erik Voldengen" email="erikv@erikv.com" role="Architect" type="Create">
		...
		<history author="Erik Voldengen" email="erikv@erikv.com" role="Architect" type="Update">
			pong!
	...
	<io>
		<in>
			<string name="SESrBaseName" scope="variables" default="base" optional="Yes" comments="the variable name to return the base ref in" oncondition="set in variables scope before this file is run"/>
			<string name="SESrBaseName" scope="attributes" default="base" optional="Yes" comments="the variable name to return the base ref in" oncondition="called as custom tag and passed as a parameter"/>
			<string name="SESrBaseName" scope="request" default="base" optional="Yes" comments="the variable name to return the base ref in" oncondition="set in request scope before this file is run"/>
...
if (Len(currentPath)) {
	...
	cleanpathinfo=RemoveChars(cleanpathinfo,1,Find("/",cleanpathinfo,Find(".cfm",cleanpathinfo,1)));
