...
<fusedoc fuse="qry_censorship.cfm">
	<responsibilities>
		I get the censorship parameters for the Forums system
	</responsibilities>
	<properties>
...
<cfinvoke component="#Application.ao__AppObj_mForum_vulgarity_Gateway#"
	method="findAll"
	orderby="vulgarity ASC"
	returnvariable="forbiddenwords">

<!--- 
$Log: qry_censorship.cfm,v $
...
Revision 1.2  2005/03/31 17:15:02  mike
modify to cll Gateway
...
Revision 1.3  2005/02/24 13:57:42  mike
edits to use <cfsilent> instead of <cfsetting >

Revision 1.2  2005/02/07 16:08:39  mike
order words alphabetically; improve fusedoc
