...
<fusedoc fuse="act_deletetoday.cfm">
	<responsibilities>
		I delete a Today notice
	</responsibilities>
	<properties>
...
<cfset stToday=structNew()>
<cfset stToday.postid=attributes.postid>
<cfset oToday=createObject("component","FuseForum.model.mForum.today").init()>
<cfset temp=oToday.setInstanceMemento(stToday)>
<cfset temp=Application.ao__AppObj_mForum_today_DAO.delete(oToday)>

<!--- 
$Log: act_deletetoday.cfm,v $
...
Revision 1.2  2005/04/06 18:13:25  mike
...
Revision 1.4  2005/02/24 13:57:21  mike
...
Revision 1.2  2005/02/09 12:09:21  mike
add addtoken="No"

Revision 1.1  2005/02/07 15:41:51  mike
new file, split off from act_posttoday.cfm
--->
</cfsilent>
