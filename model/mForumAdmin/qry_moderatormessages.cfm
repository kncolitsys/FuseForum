...
<fusedoc fuse="qry_moderatormessages.cfm">
	<responsibilities>
		I get all the messages in the given thread
	</responsibilities>
	<properties>
...
<cfinvoke component="#Application.ao__AppObj_mForum_messages_Gateway#"
	...
	orderby="messagedate"
	returnvariable="mod_messages">

<!--- 
$Log: qry_moderatormessages.cfm,v $
...
Revision 1.2  2005/04/11 12:37:14  mike
...
Revision 1.3  2005/02/24 13:57:45  mike
edits to use <cfsilent> instead of <cfsetting >

Revision 1.2  2005/02/10 11:27:03  mike
